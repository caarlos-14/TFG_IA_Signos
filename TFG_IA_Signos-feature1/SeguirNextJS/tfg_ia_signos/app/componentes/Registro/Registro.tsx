...
const Registro = () => {
  ...
  const registrarUsuario = async (e: any) => {
    ...
    try {
      const response = await fetch("https://api.carlos-sanchez.dev/insertar", {
        method: "POST",
    ...
    <div className="container-fluid p-0">
      ...
      <div className="row g-0">
        ...
        <div className="imagenes_registro col-12 col-md-12 col-lg-6 order-2 ">
          <Image
            src="/Imagenes/Seccion_Registro/inicio.jpg"
            alt="Imagen de registro"
            width={500}
            height={500}
            className="img-fluid imagen_registro "
          />
          ...
          <div className="parte_superior">
            ...
            <Image
              ...
              width={200}
              height={220}
              className="img-fluid logo_registro"
            />
          </div>
        </div>
        ...
        <div className="registro_seccion col-12 col-md-12 col-lg-6">
          ...
          <form
            className="formulario col-12 col-md-8 order-1 "
            ...
            <button type="submit" className="col-10 col-md-10">
              Registrarse
            </button>
            {mensaje && (
              <p className={`mensaje alert alert-${mensajeTipo}`}>{mensaje}</p>
            )}
            ...
            <button
              type="button"
              onClick={sesionGoogle}
              className="col-10 col-md-10">
              <Image
                src="/Imagenes/Seccion_Registro/google.svg"
                className="me-2"
                alt="Google"
                width={20}
                height={20}
