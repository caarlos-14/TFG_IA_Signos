            ...
            <div className="container-fluid mt-5">
                ...
                <div className="d-flex flex-column gap-4">
                    ...
                    <div className="d-flex flex-column">
                        ...
                        className="img-fluid"
                        />
                        <small><a href="https://www.linkedin.com/in/jorge-valverde-ballesteros-11ba4730a?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" className="text-white text-decoration-none">Linkedln Jorge Valverde</a></small>
                        </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                        ...
                        className="img-fluid"
                        />
                        <small><a href="https://www.linkedin.com/in/ángel-sebastián-vargas-callaca-a538b0390/?skipRedirect=true" target="_blank" className="text-white text-decoration-none">Linkedln Ángel Sebastián</a></small>
                        </div>
                    </div>
                </div>
                </div>
